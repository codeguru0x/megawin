/**
 * Glue wiring test — worker-keno (mock use-case, KHÔNG chạm DB).
 *
 ...
 * không kết nối DB thật. Logic nghiệp vụ đã test ở game-keno-application.
 */
...
vi.mock("@megawin/game-keno-application/use-cases/settle", () => ({
...
describe("worker-keno settle-entries handler", () => {
