/**
 * Lambda: feed-sync (Keno)
 *
 * Sync entry data từ kenoTicketEntries → entryFeed (game-core) cho tenant polling.
 ...
 *      - mapToFeedDoc: map boards + sideBets → KenoFeedBetContent.
