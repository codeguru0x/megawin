/**
 * Lambda: ops-alerts (Keno)
 *
 * Đánh giá rule alert trên stats docs ĐÃ ĐỔI kể từ cursor — tách khỏi đường ghi
 * `stats-sync` (analysis keno-stats-worker-simplification §5.1): lỗi rule alert không
 ...
 * takeover. Distributed lock `keno:ops-alerts` (TTL 120s) đảm bảo 1 invocation chạy tại
 * 1 thời điểm — độc lập lock với `keno:stats-sync`.
 */

import { EvaluateOpsAlertsUseCase } from "@megawin/game-keno-application/use-cases/operations";
