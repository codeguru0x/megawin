...
export const VOID_STATE_MACHINE = {
  ...
  States: {
    ...
    VoidEntries: {
      ...
      Output: "{% { 'context': $states.input.context, 'voidResult': $states.result } %}",
      Next: "CheckVoidDone",
      Retry: LAMBDA_RETRY,
    },
    ...
    DispatchRefunds: {
      ...
      Arguments: "{% $states.input.context %}",
      Output: "{% { 'context': $states.input.context, 'refundResult': $states.result } %}",
