/**
 * Lambda: feed-sync (Lotto 5/35)
 *
 * Sync entry data từ lotto535TicketEntries → entryFeed (game-core) cho tenant polling.
 ...
 *      - mapToFeedDoc: map lines → Lotto535FeedBetContent.
 ...
 *
 * HIỆU NĂNG:
 *   bulkWrite 500 entries ~80-150ms. Settle spike 500K entries ~2.5 phút.
 */

import { SyncEntryFeedUseCase } from "@megawin/game-lotto535-application/use-cases/feed";
