/**
 * Lambda: feed-sync (Power 6/55)
 *
 * Sync entry data từ power655TicketEntries → entryFeed (game-core) cho tenant polling.
 ...
 *      - mapToFeedDoc: map lines → Power655FeedBetContent.
 ...
 *
 * HIỆU NĂNG:
 *   bulkWrite 500 entries ~80-150ms. Worst case Jackpot lớn (1M entries) ~5 phút.
 */
