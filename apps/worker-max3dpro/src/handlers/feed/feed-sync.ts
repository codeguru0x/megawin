/**
 * Lambda: feed-sync (Max 3D Pro)
 *
 * Sync entry data từ max3dproTicketEntries → entryFeed (game-core) cho tenant polling.
 ...
 *      - mapToFeedDoc: map boards (triplets) → Max3dproFeedBetContent.
