/**
 * Glue wiring test — worker-max3d (mock use-case, KHÔNG chạm DB).
 *
 ...
 * không kết nối DB thật. Logic nghiệp vụ đã test ở game-max3d-application.
 */
...
vi.mock("@megawin/game-max3d-application/use-cases/settle", () => ({
...
describe("worker-max3d settle-entries handler", () => {
