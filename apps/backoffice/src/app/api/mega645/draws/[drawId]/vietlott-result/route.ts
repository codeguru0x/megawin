import { GetVietlottResultUseCase } from "@megawin/game-mega645-application/use-cases/draws";
...
/**
 * GET /api/mega645/draws/[drawId]/vietlott-result
 *
 * Tự lấy kết quả Vietlott đã publish (ResultFeed) để điền form nhập/sửa kết quả kỳ Mega 6/45.
