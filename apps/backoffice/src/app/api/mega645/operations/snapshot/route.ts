...
import { OpsAlertStatus } from "@megawin/game-mega645/entities";
import { GetOpsSnapshotUseCase } from "@megawin/game-mega645-application/use-cases/operations";
...
/**
 * GET /api/mega645/operations/snapshot
 *
 * Snapshot gộp mọi số liệu vận hành 1 kỳ (stats + top-K + alert count + draw status +
 * exposure jackpot) — nguồn cho **timer 1 duy nhất** ở FE (analysis §5.2).
 *
