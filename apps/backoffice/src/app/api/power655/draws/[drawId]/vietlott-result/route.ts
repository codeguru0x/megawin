import { GetVietlottResultUseCase } from "@megawin/game-power655-application/use-cases/draws";
...
/**
 * GET /api/power655/draws/[drawId]/vietlott-result
 *
 * Tự lấy kết quả Vietlott đã publish (ResultFeed) để điền form nhập/sửa kết quả kỳ Power 6/55.
