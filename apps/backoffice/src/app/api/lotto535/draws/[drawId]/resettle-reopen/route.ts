...
import { ReopenForCascadeUseCase } from "@megawin/game-lotto535-application/use-cases/draws";
...
/**
 * POST /api/lotto535/draws/[drawId]/resettle-reopen
 *
 ...
 * không đổi. Luồng publish-result thông thường return sớm khi result không đổi
 * nên không mở được `Settled → Published`. Endpoint này re-stamp
 * `result.publishedAt` (GIỮ nguyên winningMain + winningSpecial) để vượt cổng
 * `DRAW_NO_NEW_RESULT`, sau đó staff bấm "Kết sổ lại".
 *
 * Yêu cầu:
