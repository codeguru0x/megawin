import { GetOpsSnapshotUseCase } from "@megawin/game-lotto535-application/use-cases/operations";
import { OpsAlertStatus } from "@megawin/game-lotto535/entities";
...
/**
 * GET /api/lotto535/operations/snapshot
 *
 * Snapshot gộp mọi số liệu vận hành 1 kỳ (stats + top-K + alert count + draw status +
 * exposure jackpot) — nguồn cho **timer 1 duy nhất** ở FE (analysis §5.2, mirror Power
 * 6/55 D2).
 *
