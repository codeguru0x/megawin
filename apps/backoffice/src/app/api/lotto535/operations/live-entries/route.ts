...
import { GetLiveEntriesUseCase } from "@megawin/game-lotto535-application/use-cases/operations";
import { z } from "zod";

const useCase = new GetLiveEntriesUseCase();

/**
 * GET /lotto535/operations/live-entries?drawId=xxx&limit=50
 *
 * Trả về N entries mới nhất của một kỳ quay.
