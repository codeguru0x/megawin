...
import { GetLiveEntriesUseCase } from "@megawin/game-max3dpro-application/use-cases/operations";
import { liveEntriesQuerySchema } from "../_lib/schema";

const useCase = new GetLiveEntriesUseCase();

/**
 * GET /max3dpro/operations/live-entries?drawId=xxx&limit=50
 *
 * Trả về N entries mới nhất của một kỳ quay Max 3D Pro.
