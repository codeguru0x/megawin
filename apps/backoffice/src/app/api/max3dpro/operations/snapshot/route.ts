import { GetOpsSnapshotUseCase } from "@megawin/game-max3dpro-application/use-cases/operations";
...
/**
 * GET /api/max3dpro/operations/snapshot
 *
 * Snapshot gộp mọi số liệu vận hành 1 kỳ (stats + exposure + alert count + draw status)
 * — nguồn cho **timer 1 duy nhất** ở FE, thay 6 request aggregation on-demand cũ.
 *
