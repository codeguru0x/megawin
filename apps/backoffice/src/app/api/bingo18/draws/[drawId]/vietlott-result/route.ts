import { GetVietlottResultUseCase } from "@megawin/game-bingo18-application/use-cases/draws";
...
/**
 * GET /api/bingo18/draws/[drawId]/vietlott-result
 *
 * Tự lấy kết quả Vietlott đã publish (ResultFeed) để điền form nhập/sửa kết quả kỳ Bingo 18.
