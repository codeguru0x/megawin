import { GetOpsSnapshotUseCase } from "@megawin/game-keno-application/use-cases/operations";
...
/**
 * GET /api/keno/operations/snapshot
 *
 * Snapshot gộp mọi số liệu vận hành 1 kỳ (stats + alert count + draw status) — nguồn cho
 * **timer 1 duy nhất** ở FE (analysis §4.1), thay 5–6 request aggregation on-demand cũ.
 *
