    ...
    <div className="@container/main flex flex-col gap-4 md:gap-6">
      ...
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-foreground text-lg font-semibold tracking-tight">Outstanding — Số liệu đang chờ</h1>
        ...
        <CardContent className="px-0 pt-0 pb-4">
          {error ? (
            ...
            <div className="flex h-50 flex-col items-center justify-center gap-1 text-center">
              <p className="text-muted-foreground text-sm font-medium">Không có draw active nào trên hệ thống.</p>
            </div>
          ) : (
            <div className="overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  {rows.map((row) => {
                    ...
                    return (
                      <TableRow
                        key={row.gameProduct}
                        className={cn(slug && "hover:bg-muted/50 cursor-pointer")}
                ...
                {rows.length > 1 && (
                  <tfoot>
                    <TableRow className="bg-muted/50 border-t font-medium">
