...
import {
  useBingo18GameConfig,
  useUpdateBingo18GameConfig,
} from "./_lib/use-game-config";
    ...
    <div className="@container/main flex flex-col gap-2">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="flex size-8 items-center justify-center rounded-lg bg-linear-to-br from-amber-500 to-orange-600 shadow-sm">
