...
export default function Bingo18TenantConfigPage() {
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <Badge
                    variant="secondary"
                    className="border-emerald-200 bg-emerald-100 font-mono text-[11px] text-emerald-700 tabular-nums dark:border-emerald-800 dark:bg-emerald-950/50 dark:text-emerald-400"
                  >
                    v{config.version}
                  </Badge>
                </div>
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Chọn đại lý từ hệ thống để tạo cấu hình Bingo 18. Chỉ hiển thị đại
            lý chưa có cấu hình.
          </DialogDescription>
        </DialogHeader>
