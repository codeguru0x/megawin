    ...
    <div className="@container/main flex flex-col gap-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-foreground text-lg font-semibold tracking-tight">Bingo 18 — Vận hành</h1>
            <div className="flex items-center gap-2">
              <p className="text-muted-foreground text-xs">Quản lý và giám sát kỳ quay (~158 kỳ/ngày)</p>
      ...
      <div className="flex flex-col items-center justify-center rounded-xl border border-dashed py-20 text-center">
        ...
        <div className="mt-5 flex items-center gap-3">
          <Button variant="outline" size="sm" asChild>
            <Link prefetch={false} href="/games/bingo18/draws">
              Lịch sử kỳ quay
            </Link>
          </Button>
          {noData ? (
            ...
            <Button size="sm" asChild>
              <Link prefetch={false} href="/games/bingo18/operations">
                Về trang vận hành
              </Link>
            </Button>
          )}
