 ...
 * - Boards: singleNum, doubleMatch, tripleMatch
 * - Side bets: sumTotal, bigSmallDraw
...
export interface OpsKpi {
  ...
  totalRevenue: number;
  totalEntries: number;
  /** Số basic boards (singleNum, doubleMatch, tripleMatch). */
  totalBoards: number;
  /** Số side bets (sumTotal, bigSmallDraw). */
...
export interface LiveFeedEntry {
  entryId: string;
  time: string;
  /** Play type của board/sideBet đầu tiên để hiển thị preview. */
  playType: string;
