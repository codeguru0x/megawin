      ...
      <DialogContent className="sm:max-w-2xl">
          ...
          <div className="flex flex-wrap items-end gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex h-9 flex-wrap items-center gap-1.5">
                ...
                {openCount > 0 && (
                  <Badge className="bg-amber-600 text-xs text-white hover:bg-amber-600">{openCount} mở bán</Badge>
                )}
                {scheduledCount > 0 && (
              ...
              <div className="divide-border/50 h-[min(33rem,45vh)] divide-y overflow-y-auto">
                ...
                {rows.map((row, i) => (
                  ...
                  >
                    ...
                    >
                      {row.isOpen ? (
                        <Unlock className="size-3 shrink-0 text-amber-500" />
                      ) : (
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={!canSubmit}
            className={cn(openCount > 0 && "bg-amber-600 text-white hover:bg-amber-700")}
          >
