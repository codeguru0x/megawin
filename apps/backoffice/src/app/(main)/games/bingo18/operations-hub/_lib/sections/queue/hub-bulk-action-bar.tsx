  ...
  return (
    <>
      ...
      <div
        ...
        className="border-primary/30 bg-card dark:border-primary/40 shadow-float-up dark:shadow-float-up-dark sticky bottom-0 z-20 flex items-center justify-between gap-4 border-t-2 px-4 py-3"
      >
