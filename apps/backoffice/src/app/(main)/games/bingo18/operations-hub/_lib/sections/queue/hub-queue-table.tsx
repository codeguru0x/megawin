...
import { PublishResultAction } from "@/app/(main)/games/bingo18/operations/_lib/sections/draw-management/draw-actions/publish-result-action";
...
export function HubQueueTable() {
  ...
  // `PublishResultAction` trong first-load của Hub. Xem comment tại render site cuối file.
