  ...
  return (
    ...
    >
      ...
      <CardHeader className="pb-4">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            >
              <Dice5 className={`size-5 ${vis.iconColor}`} />
      ...
      <CardContent className="space-y-5">
        {/* Dice Result */}
        {draw.result && (
          <div className="flex items-center gap-4 rounded-xl border bg-white/80 dark:bg-card p-4">
            <DiceDisplay numbers={draw.result.diceNumbers} size="lg" showSum />
          </div>
        )}
