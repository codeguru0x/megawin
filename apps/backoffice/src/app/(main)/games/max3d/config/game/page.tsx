  ...
  return (
    <div className="@container/main flex flex-col gap-2">
      <div className="flex items-center gap-2.5">
        <div className="from-game-max3d to-game-max3d-muted flex size-8 items-center justify-center rounded-lg bg-linear-to-br shadow-sm">
          <Settings2 className="size-4 text-white" />
        </div>
        <div>
          <h1 className="text-foreground text-base font-semibold tracking-tight">Max 3D — Cấu hình</h1>
          {config && (
