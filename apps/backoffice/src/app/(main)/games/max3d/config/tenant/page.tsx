    ...
    <div className="@container/main flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-semibold tracking-tight text-foreground">Max 3D — Cấu hình đại lý</h1>
        ...
        <DialogHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <DialogDescription className="text-xs">Chọn đại lý từ hệ thống để tạo cấu hình Max 3D.</DialogDescription>
            </div>
          </div>
        </DialogHeader>
