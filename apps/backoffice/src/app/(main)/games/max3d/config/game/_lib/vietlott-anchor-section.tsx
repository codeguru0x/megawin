 ...
 *
 * Max 3D quay theo THỨ trong tuần (`drawDaysOfWeek`, mặc định T2-T4-T6) VÀ có THỂ có nhiều
 * giờ quay/ngày (`drawTimes[]`) — neo phải rơi vào đúng 1 ngày quay VÀ đúng 1 trong các giờ
 * quay hiện tại, KHÔNG phải ngày/giờ bất kỳ. Chọn kỳ nào đang thấy trên trang Vietlott, càng
 * gần hiện tại càng tốt.
 */
