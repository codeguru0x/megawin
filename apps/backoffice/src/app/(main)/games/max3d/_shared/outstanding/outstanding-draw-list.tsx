...
interface OutstandingDrawListProps {
  /** Danh sách draws outstanding (từ useMax3DOutstanding). */
 ...
 *
 * Tự gọi useMax3DOutstandingFilters() để lấy navigateToDraw — cùng pattern với financial reports.
 ...
 * Label "Cặp số" thay "Dòng cược" vì Max 3D dùng triplets (straight=1, combo3=3, combo6=6).
 */
export function OutstandingDrawList({ data }: OutstandingDrawListProps) {
  const { navigateToDraw } = useMax3DOutstandingFilters();
