...
const MOCK_TENANT_SUMMARY = [
  {
    ...
    entryCount: 4150,
    totalLines: 12_600,
    totalAmount: 126_000_000,
    playerCount: 312,
    avgAmountPerPlayer: 403_846,
  },
  {
    tenantId: "T002",
    ...
    entryCount: 3280,
    totalLines: 8_450,
    totalAmount: 84_500_000,
    playerCount: 231,
    avgAmountPerPlayer: 365_800,
  },
  {
    tenantId: "T003",
    ...
    boards: [
      {
        boardNo: "A",
        playType: "combo3",
        triplets: ["223", "445", "667", "889"],
        expandedLines: 12,
      },
      {
        boardNo: "B",
        playType: "straight",
        triplets: ["000", "111", "222"],
        expandedLines: 3,
      },
    ],
    lineCount: 15,
    ...
    <div className="@container/main flex flex-col gap-4 md:gap-6">
      ...
      <div className="flex items-center gap-2">
        <Select defaultValue={PENDING_DRAW.drawId}>
          ...
          <SelectContent>
            <SelectItem value="2026-02-22-001">
              2026-02-22 Kỳ 1 (18:15) – Đang bán
            </SelectItem>
            <SelectItem value="2026-02-23-001">
              2026-02-23 Kỳ 1 (18:15) – Đã lên lịch
            </SelectItem>
            <SelectItem value="2026-02-24-001">
              2026-02-24 Kỳ 1 (18:15) – Đã lên lịch
            </SelectItem>
          </SelectContent>
        </Select>
      </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Select defaultValue="all">
                  ...
                  <SelectContent>
                    <SelectItem value="all">Tất cả</SelectItem>
                    <SelectItem value="straight">Cơ Bản</SelectItem>
                    <SelectItem value="combo3">Tổ Hợp 3</SelectItem>
                    <SelectItem value="combo6">Tổ Hợp 6</SelectItem>
                    <SelectItem value="plus">Max 3D+</SelectItem>
                  </SelectContent>
                </Select>
