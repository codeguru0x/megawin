    ...
    <div className="@container/main flex flex-col gap-6">
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-foreground text-lg font-semibold tracking-tight">Max 3D — Quản lý kỳ quay</h1>
      ...
      {isLoading ? (
        ...
        <div className="bg-muted/30 flex flex-col items-center justify-center gap-4 rounded-xl border border-dashed p-16 text-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1 text-xs">Vào trang Vận hành để tạo kỳ quay mới.</p>
          </div>
        </div>
      )}
