...
const MOCK_TICKETS = [
  {
    ...
    boards: [
      { boardNo: "A", playType: "straight", triplets: ["123", "456", "789"], expandedLines: 3 },
      { boardNo: "B", playType: "combo3", triplets: ["112", "334"], expandedLines: 6 },
      { boardNo: "C", playType: "straight", triplets: ["001", "999", "555", "777", "888"], expandedLines: 5 },
    ],
  },
  {
    ticketId: "TK30002",
    ticketNo: "M3D-20260222-00046",
    playerId: "P002",
    ...
    boards: [
      { boardNo: "A", playType: "straight", triplets: ["246", "135"], expandedLines: 2 },
    ],
  },
  {
    ticketId: "TK30003",
    ticketNo: "M3D-20260221-00012",
    playerId: "P003",
    playerName: "Lê Văn C",
    tenantId: "T002",
    ...
    boards: [
      { boardNo: "A", playType: "combo6", triplets: ["123", "456", "789"], expandedLines: 18 },
      { boardNo: "B", playType: "plus", triplets: ["001", "555"], expandedLines: 2 },
      { boardNo: "C", playType: "straight", triplets: ["333", "666", "999"], expandedLines: 3 },
      { boardNo: "D", playType: "combo3", triplets: ["112", "334", "556", "778", "990"], expandedLines: 15 },
    ],
  },
  {
    ticketId: "TK30004",
    ticketNo: "M3D-20260221-00013",
    playerId: "P004",
    ...
    boards: [
      { boardNo: "A", playType: "straight", triplets: ["007", "070", "700"], expandedLines: 3 },
    ],
  },
  {
    ticketId: "TK30005",
    ticketNo: "M3D-20260222-00047",
    playerId: "P005",
    ...
    boards: [
      { boardNo: "A", playType: "combo6", triplets: ["123", "456", "789", "012"], expandedLines: 24 },
      { boardNo: "B", playType: "plus", triplets: ["555", "888", "111"], expandedLines: 3 },
    ],
  },
  {
    ticketId: "TK30006",
    ticketNo: "M3D-20260220-00008",
    playerId: "P006",
    ...
    boards: [
      { boardNo: "A", playType: "straight", triplets: ["111", "222", "333", "444", "555"], expandedLines: 5 },
    ],
  },
  {
    ticketId: "TK30007",
    ticketNo: "M3D-20260222-00048",
    playerId: "P007",
    playerName: "Đỗ Thị G",
    tenantId: "T004",
    ...
    boards: [
      { boardNo: "A", playType: "combo3", triplets: ["223", "445", "667"], expandedLines: 9 },
      { boardNo: "B", playType: "straight", triplets: ["000"], expandedLines: 1 },
    ],
  },
  {
    ticketId: "TK30008",
    ticketNo: "M3D-20260219-00003",
    playerId: "P008",
    ...
    boards: [
      { boardNo: "A", playType: "straight", triplets: ["369", "147", "258", "036"], expandedLines: 4 },
      { boardNo: "B", playType: "plus", triplets: ["999", "888", "777", "666"], expandedLines: 4 },
    ],
  },
];
    ...
    <div className="@container/main flex flex-col gap-4 md:gap-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Tra cứu và quản lý tất cả vé Max 3D theo trạng thái, đại lý, người chơi.
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard
          ...
          description="Giá trị toàn bộ vé"
          icon={CircleDollarSign}
        />
        <StatCard
          title="Vé hoạt động"
          value={activeCount.toLocaleString("vi-VN")}
          description="Đang tham gia kỳ quay"
          icon={Activity}
        />
        <StatCard
          title="Vé hoàn tất"
          value={completedCount.toLocaleString("vi-VN")}
          description="Đã settle xong"
          icon={CheckCircle2}
        />
      </div>
      ...
      <Card>
        <CardContent className="flex flex-wrap items-center gap-2 py-3">
          <div className="relative w-64">
            ...
            <Input
              placeholder="Mã vé, người chơi, đại lý..."
              className="pl-8"
              value={searchQuery}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Hiển thị {filtered.length} / {totalTickets} vé · Trang {currentPage}
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                {filtered.map((ticket) => (
                  <TableRow key={ticket.ticketId}>
                    ...
                    <TableCell className="text-center">
                      <Badge variant="outline">{ticket.drawCount}</Badge>
                    </TableCell>
      ...
      >
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Người chơi: {ticketDetail?.playerName} · {ticketDetail?.tenantName}
            </DialogDescription>
          </DialogHeader>
          {ticketDetail && (
                    ...
                    <div className="flex flex-wrap items-center gap-1.5">
                      {board.triplets.map((triplet, idx) => (
                        <TripletDisplay
                          key={idx}
                          value={triplet}
                          variant={board.playType === "plus" ? "special" : "default"}
                          size="sm"
                        />
                      ))}
                    </div>
