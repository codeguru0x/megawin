 ...
 *
 * Tạo nhiều kỳ quay Max 3D liên tiếp (1 kỳ/ngày, lịch T2/T4/T6 lúc 18:00).
...
/** Số kỳ mặc định mỗi lần mở dialog — Max 3D quay 3 kỳ/tuần (T2/T4/T6), mặc định 1 tuần. */
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <CalendarPlus className="size-4.5 text-green-500" />
            Tạo kỳ quay Max 3D
          </DialogTitle>
          <DialogDescription>
          ...
          <div className="flex flex-wrap items-end gap-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  if (!isNaN(v) && v >= 1 && v <= MAX3D_CREATE_DRAW_BATCH_MAX) {
                    setCount(v);
                  }
                }}
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex h-9 flex-wrap items-center gap-1.5">
                ...
                {openCount > 0 && (
                  <Badge className="bg-green-600 text-xs text-white hover:bg-green-600">{openCount} mở bán</Badge>
                )}
                {scheduledCount > 0 && (
                ...
                >
                  ...
                  <span
                    className={cn(
                      ...
                      row.isOpen ? "text-green-700 dark:text-green-300" : "text-foreground",
                    )}
                  >
                    {i + 1}
                  </span>
                  ...
                  >
                    {row.isOpen ? (
                      <Unlock className="size-3 shrink-0 text-green-500" />
                    ) : (
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={!canSubmit}
            className={cn(openCount > 0 && "bg-green-600 text-white hover:bg-green-700")}
          >
