 ...
 * Max 3D khác Keno:
 * - Lịch quay: T2/T4/T6 lúc 18:00 (3 kỳ/tuần, 1 kỳ/ngày)
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Tạo các kỳ quay tiếp theo. Max 3D quay vào Thứ 2/4/6 lúc 18:00 — backend tự tính ngày và
            số thứ tự kỳ (drawNo) theo lịch cố định.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-1">
          ...
          <div className="flex items-start gap-2 rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 px-3 py-2.5">
            <CalendarDays className="size-3.5 text-blue-500 shrink-0 mt-0.5" />
            <div className="space-y-0.5">
              <p className="text-xs font-medium text-blue-700 dark:text-blue-300">
                Lịch quay T2, T4, T6 · 18:00
              </p>
