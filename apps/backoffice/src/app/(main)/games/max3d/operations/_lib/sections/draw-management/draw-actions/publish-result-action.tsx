...
function validateMax3d(tiers: { key: string; label: string; values: string[] }[]): ValidationResult {
          ...
          <DialogDescription className="flex items-center gap-2">
            ...
            <Tooltip>
              ...
              <TooltipContent side="bottom" className="max-w-xs">
                20 bộ ba số từ &apos;000&apos; đến &apos;999&apos;. Gồm 4 giải: Đặc Biệt (2), Nhất (4), Nhì (6), Ba (8).
              </TooltipContent>
            </Tooltip>
          </DialogDescription>
        </DialogHeader>
