...
const MOCK_DRAWS = [
  ...
  },
  {
    ...
    revenue: 198_200_000,
    payout: 55_496_000,
    commission: 39_640_000,
    profit: 103_064_000,
  },
  {
    drawId: "2026-02-19-001",
    drawDate: "2026-02-19",
    drawNo: 1,
    drawTime: "18:15",
    status: "settled",
    ...
    revenue: 225_800_000,
    payout: 33_870_000,
    commission: 45_160_000,
    profit: 146_770_000,
  },
  {
    drawId: "2026-02-18-001",
    drawDate: "2026-02-18",
    drawNo: 1,
    drawTime: "18:15",
    status: "settled",
    ...
    <div className="@container/main flex flex-col gap-4 md:gap-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          description={`${settledDraws.length} kỳ đã settle`}
        ...
        <StatCard
          ...
          description={`Rate: ${((totalPayout / totalRevenue) * 100).toFixed(1)}%`}
          icon={TrendingUp}
        />
        <StatCard
          title="Tổng entries"
          value={totalEntries.toLocaleString("vi-VN")}
          description={`TB ${Math.round(totalEntries / settledDraws.length).toLocaleString("vi-VN")}/kỳ`}
          icon={Ticket}
        />
        <StatCard
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {MOCK_DRAWS.length} kỳ quay trong khoảng thời gian đã chọn
          </CardDescription>
        </CardHeader>
        <CardContent>
