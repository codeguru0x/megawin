...
import { useMega645OutstandingDrawTenants } from "../../financial-reports/_lib/use-report-queries";
 ...
 *
 * Tự gọi useMega645OutstandingFilters() để lấy navigateToTenant — cùng pattern với financial reports.
...
export function OutstandingTenantBreakdown({ drawId }: OutstandingTenantBreakdownProps) {
  const { navigateToTenant } = useMega645OutstandingFilters();
  const { data, isLoading, error, refetch } = useMega645OutstandingDrawTenants(drawId);
