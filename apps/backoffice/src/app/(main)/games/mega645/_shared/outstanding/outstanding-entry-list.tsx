...
import { Mega645EntryDetailDialog } from "../../financial-reports/_lib/sections/entry-list";
import { useMega645OutstandingPlayerEntries } from "../../financial-reports/_lib/use-report-queries";
 ...
 *
 * Click row → mở Mega645EntryDetailDialog ở outstanding mode
...
export function OutstandingEntryList({
  ...
  const { data, isLoading, error, refetch } = useMega645OutstandingPlayerEntries(
    drawId,
    tenantId,
    accountId,
  );
