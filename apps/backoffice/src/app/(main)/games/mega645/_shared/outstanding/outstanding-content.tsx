...
/**
 * Orchestrator cho Mega 6/45 Outstanding drill-down.
 *
 * Render đúng level component dựa trên URL state từ useMega645OutstandingFilters.
 * KpiStrip chỉ hiển thị ở Level 1.
 * Breadcrumb hiển thị từ Level 2 trở lên.
 */
export function OutstandingContent() {
  const { drawId, tenantId, playerId, playerName, level } = useMega645OutstandingFilters();

  const { data, isLoading, error, isFetching, refetch } = useMega645Outstanding();
