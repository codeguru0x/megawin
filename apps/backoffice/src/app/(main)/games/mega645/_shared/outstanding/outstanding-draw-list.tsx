...
interface OutstandingDrawListProps {
  /** Danh sách draws outstanding (từ useMega645Outstanding). */
 ...
 *
 * Tự gọi useMega645OutstandingFilters() để lấy navigateToDraw — cùng pattern với financial reports.
...
export function OutstandingDrawList({ data }: OutstandingDrawListProps) {
  const { navigateToDraw } = useMega645OutstandingFilters();
