...
import { useMega645Outstanding } from "../financial-reports/_lib/use-report-queries";
...
function OutstandingTable() {
  const { data, isLoading, error, dataUpdatedAt } = useMega645Outstanding();
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="text-xs">
                Tự động refresh mỗi 60 giây · Mega 6/45 có tối đa ~3 kỳ outstanding
...
function Mega645OutstandingContent() {
  return (
