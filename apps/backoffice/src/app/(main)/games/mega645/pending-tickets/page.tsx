...
const PENDING_DRAW = {
  ...
  schedule: "T7",
  status: "salesOpen",
  salesCloseAt: "2026-03-01 17:30",
  jackpotAmount: 12_350_000_000,
};
...
const MOCK_TENANT_SUMMARY = [
  {
    ...
    entryCount: 2850,
    totalLines: 7120,
    totalAmount: 71_200_000,
    playerCount: 198,
    avgAmountPerPlayer: 359_596,
  },
  {
    tenantId: "T002",
    ...
    entryCount: 2240,
    totalLines: 4680,
    totalAmount: 46_800_000,
    playerCount: 156,
    avgAmountPerPlayer: 300_000,
  },
  {
    tenantId: "T003",
  ...
  },
  {
    ...
    entryCount: 640,
    totalLines: 1420,
    totalAmount: 14_200_000,
    playerCount: 48,
    avgAmountPerPlayer: 295_833,
  },
];
...
export default function Mega645PendingTicketsPage() {
  ...
  return (
    <div className="@container/main flex flex-col gap-4 md:gap-6">
      ...
      <Card className="bg-linear-to-r from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30">
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              ...
              <p className="text-lg font-bold tabular-nums text-amber-600 dark:text-amber-400">
                {fmtVND(PENDING_DRAW.jackpotAmount)}
              </p>
            </div>
          </div>
          <div className="flex items-center gap-4">
      ...
      <div className="flex items-center gap-2">
        <Select defaultValue={PENDING_DRAW.drawId}>
          ...
          <SelectContent>
            <SelectItem value="2026-03-01-T7">2026-03-01 T7 (18:00) – Đang bán</SelectItem>
            <SelectItem value="2026-03-04-T3">2026-03-04 T3 (18:00) – Đã lên lịch</SelectItem>
            <SelectItem value="2026-03-06-T5">2026-03-06 T5 (18:00) – Đã lên lịch</SelectItem>
          </SelectContent>
        </Select>
      </div>
