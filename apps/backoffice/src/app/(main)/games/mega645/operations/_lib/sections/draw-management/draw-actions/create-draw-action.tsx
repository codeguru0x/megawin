      ...
      <DialogContent className="sm:max-w-2xl">
          ...
          <div className="flex flex-wrap items-end gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex h-9 flex-wrap items-center gap-1.5">
                ...
                {openCount > 0 && (
                  <Badge className="bg-teal-600 text-xs text-white hover:bg-teal-600">{openCount} mở bán</Badge>
                )}
                {scheduledCount > 0 && (
                ...
                >
                  ...
                  <span
                    className={cn(
                      ...
                      row.isOpen ? "text-teal-700 dark:text-teal-300" : "text-foreground",
                    )}
                  >
                    {i + 1}
                  </span>
                  ...
                  >
                    {row.isOpen ? (
                      <Unlock className="size-3 shrink-0 text-teal-500" />
                    ) : (
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={!canSubmit}
            className={cn(openCount > 0 && "bg-teal-600 text-white hover:bg-teal-700")}
          >
