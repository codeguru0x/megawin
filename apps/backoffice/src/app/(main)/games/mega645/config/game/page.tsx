...
import { DollarSign, ExternalLink, Percent, Radio, Settings2, Trophy } from "lucide-react";
  ...
  return (
    <div className="@container/main flex flex-col gap-2">
      <div className="flex items-center gap-2.5">
        ...
        <div>
          <h1 className="text-foreground text-base font-semibold tracking-tight">Mega 6/45 — Cấu hình</h1>
          {config && (
