 ...
 *
 * Mega 6/45 quay theo THỨ trong tuần (`drawDaysOfWeek`) — neo phải rơi vào đúng 1 ngày quay,
 * KHÔNG phải ngày bất kỳ. Chọn kỳ nào đang thấy trên trang Vietlott, càng gần hiện tại càng tốt.
 */
        ...
        <form onSubmit={form.handleSubmit(handleSubmit)}>
          <CardContent className="p-6 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  ...
                  neo phải LÀ một ngày quay theo lịch hiện tại. Hệ thống dùng neo này để tự gợi ý mã kỳ cho các kỳ khác
                  khi công bố kết quả.
                </p>
              </div>
            </div>
            ...
            <p className="text-xs text-muted-foreground">
              ⚠️ Ngày bạn nhập ở trên phải là một ngày có quay số theo lịch hiện tại (mục "Lịch quay số" bên trên), và
              giờ quay phải đúng với giờ đang cấu hình. Nếu sau này lịch quay số thay đổi (thứ trong tuần hoặc giờ
              quay), phải cập nhật lại thông tin ở đây — nếu không, hệ thống sẽ gợi ý sai mã kỳ cho các kỳ sau.
            </p>
          </CardContent>
