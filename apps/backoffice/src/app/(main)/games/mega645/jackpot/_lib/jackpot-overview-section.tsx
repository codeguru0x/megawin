    ...
    <div className="space-y-4">
      ...
      <div
        className={cn(
          ...
          "bg-linear-to-br from-orange-50/90 via-amber-50/70 to-yellow-50/50",
      ...
      >
        ...
        <div className="pointer-events-none absolute -left-8 bottom-0 size-32 rounded-full bg-linear-to-tr from-orange-200/20 to-amber-200/10 blur-2xl dark:from-orange-600/10 dark:to-amber-600/5" />

        <div className="relative space-y-5">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-3.5">
              <div className="flex size-12 items-center justify-center rounded-xl bg-linear-to-br from-orange-400 to-amber-500 shadow-lg shadow-orange-500/30">
                <Trophy className="size-6 text-white" />
              </div>
              <div>
                <p className="text-xs font-medium uppercase tracking-wider text-orange-700/70 dark:text-orange-400/60">
                  Jackpot hiện tại — Cycle #{cycle.cycleNo}
                </p>
                <p className="mt-0.5 text-3xl font-extrabold tabular-nums tracking-tight text-orange-900 dark:text-orange-100">
          ...
          <div className="space-y-2">
            ...
            <div className="h-3 w-full overflow-hidden rounded-full bg-orange-200/60 dark:bg-orange-900/50">
              <div
