...
/**
 * Keno — Ops Hub (Trung tâm vận hành đa kỳ)
 *
 * Trang giám sát TẤT CẢ kỳ chưa hoàn thành cùng lúc (~119 kỳ/ngày), khác hẳn trang
...
function openDrawInNewTab(drawId: string) {
  window.open(drawOperationsHref(GameProduct.Keno, drawId), "_blank", "noopener");
}
