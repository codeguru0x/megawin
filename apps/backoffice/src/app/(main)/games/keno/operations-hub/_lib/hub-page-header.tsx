 ...
 *
 * KHÔNG hiện "Ngày tài chính": 1 ngày Keno cắt qua 2 ngày tài chính (mốc 11:00) — hiện 1 giá
 ...
 * `keno/operations/page.tsx:46-61`). `> 3 × pollSeconds` không tươi → chuyển "Chậm" (màu amber,
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="font-semibold text-foreground text-lg tracking-tight">Keno — Trung tâm vận hành</h1>
