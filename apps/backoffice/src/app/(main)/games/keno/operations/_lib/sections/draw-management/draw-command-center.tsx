...
export function DrawCommandCenter({
  ...
  const accentGradient =
    {
      [DrawStatus.SalesOpen]: "from-warning via-warning to-warning",
  ...
  const cardBg =
    {
      [DrawStatus.SalesOpen]: "bg-linear-to-br from-warning/60 via-card to-warning/30 dark:via-card",
  ...
  const cardBorder =
    {
      [DrawStatus.SalesOpen]: "border-warning",
  ...
  const iconBg =
    {
      [DrawStatus.SalesOpen]: "bg-warning",
  ...
  const iconColor =
    {
      [DrawStatus.SalesOpen]: "text-warning",
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                ...
                <DropdownMenuItem asChild>
                  <Link prefetch={false} href={`/games/keno/reports/settle?drawId=${draw.drawId}&level=draw-tenants`}>
