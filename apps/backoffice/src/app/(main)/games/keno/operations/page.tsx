 ...
 * Keno: refetch mỗi 15s do chu kỳ ngắn (~8 phút).
 * Dùng DOM ref + setInterval để tránh re-render React.
 */
function LastUpdatedBadge({
  ...
  useEffect(() => {
    function tick() {
      const queryKey = kenoKeys.opsSummary(opsParams as Record<string, unknown>);
...
function OperationsContent() {
  ...
  return (
    <div className="@container/main flex flex-col gap-6">
      ...
      {/* Zone 4: Analytics — kiểu chơi, heatmap 80 số, live feed */}
      <AnalyticsSection />
    </div>
  );
}
