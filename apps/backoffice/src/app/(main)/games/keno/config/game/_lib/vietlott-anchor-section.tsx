        ...
        <form onSubmit={form.handleSubmit(handleSubmit)}>
          <CardContent className="space-y-4 p-6">
            ...
            <p className="text-muted-foreground text-xs">
              ⚠️ Giờ quay bạn nhập ở trên phải đúng với lịch quay số đang cấu hình ở mục "Lịch quay số" bên trên. Nếu
              sau này lịch quay số thay đổi (giờ kỳ đầu, giờ kỳ cuối, hoặc khoảng cách giữa các kỳ), phải cập nhật lại
              thông tin ở đây — nếu không, hệ thống sẽ gợi ý sai mã kỳ cho các kỳ sau.
            </p>
          </CardContent>
