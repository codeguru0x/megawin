...
function OutstandingTable() {
  const { data, isLoading, error, dataUpdatedAt } = useKenoOutstanding();
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="text-xs">
                Tự động refresh mỗi 60 giây · Keno có thể có ~10+ active draws cùng lúc
...
function KenoOutstandingContent() {
  return (
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Entries chưa settle · Snapshot TTL 15 phút · Tự động refresh mỗi 60s · ~10+ active draws
          </p>
        </div>
      </div>
