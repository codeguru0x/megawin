...
interface OutstandingDrawListProps {
  /** Danh sách draws outstanding (từ useKenoOutstanding). */
 ...
 *
 * Keno có ~10+ draws active cùng lúc (8 phút/kỳ) — bảng có thể dài hơn các game khác.
 * Tự gọi useKenoOutstandingFilters() để lấy navigateToDraw.
 * Click row → drill vào Tenant Breakdown.
 * Keno KHÔNG có lineCount — 7 cột thay vì 8.
 */
export function OutstandingDrawList({ data }: OutstandingDrawListProps) {
  const { navigateToDraw } = useKenoOutstandingFilters();
