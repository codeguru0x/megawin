    ...
    <div className="@container/main flex flex-col gap-6">
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-foreground text-lg font-semibold tracking-tight">Keno — Kỳ quay</h1>
            <p className="text-muted-foreground text-xs">Tổng quan kỳ quay hiện tại và lịch sử (~119 kỳ/ngày)</p>
          </div>
        </div>
      </div>
