  ...
  return (
    <div className="@container/main flex flex-col gap-2">
      <div className="flex items-center gap-2.5">
        <div className="from-warning to-loss flex size-8 items-center justify-center rounded-lg bg-linear-to-br shadow-sm">
          <Settings2 className="size-4 text-white" />
        </div>
        <div>
          <h1 className="text-foreground text-base font-semibold tracking-tight">Lotto 5/35 — Cấu hình</h1>
          {config && (
