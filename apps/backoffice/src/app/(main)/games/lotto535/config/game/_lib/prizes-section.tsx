          ...
          <CardContent className="p-0">
            <div className="grid gap-0 lg:grid-cols-[3fr_2fr]">
              ...
              <div className="border-t p-6 lg:border-l lg:border-t-0 overflow-x-auto">
                ...
                <div className="rounded-lg border overflow-hidden">
                  {/* Header */}
                  <div className="grid grid-cols-[1fr_112px_120px_108px_88px] items-center gap-3 bg-muted/40 px-6 py-2.5 text-xs font-medium uppercase tracking-wider text-muted-foreground min-w-[560px]">
                    <span>Hạng giải</span>
                  ...
                  {oddsTable.map((row, idx) => {
                    ...
                    return (
                      <div
                        key={row.tier}
                        className={`grid grid-cols-[1fr_112px_120px_108px_88px] items-center gap-3 px-6 py-3 text-xs transition-colors hover:bg-muted/20 min-w-[560px] ${
                  ...
                  {/* Total row */}
                  <div className="grid grid-cols-[1fr_112px_120px_108px_88px] items-center gap-3 rounded-b-md border-t-2 bg-muted/30 px-6 py-2.5 text-xs font-semibold uppercase tracking-wider min-w-[560px]">
                    <span>Tổng cộng</span>
                    <span />
                    <span />
