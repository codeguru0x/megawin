            ...
            <div className="grid gap-0 lg:grid-cols-[3fr_2fr]">
              ...
              <div className="overflow-x-auto border-t p-6 lg:border-t-0 lg:border-l">
                <div className="mb-4">
                  ...
                  <p className="text-muted-foreground mt-0.5 text-xs">Toàn bộ hạng giải bao gồm Jackpot Độc Đắc.</p>
                </div>

                <div className="overflow-hidden rounded-lg border">
                  {/* Header */}
                  <div className="bg-muted/40 text-muted-foreground grid min-w-140 grid-cols-[1fr_112px_120px_108px_88px] items-center gap-3 px-6 py-2.5 text-xs font-medium tracking-wider uppercase">
                    <span>Hạng giải</span>
                  ...
                  {oddsTable.map((row, idx) => {
                    ...
                    return (
                      <div
                        key={row.tier}
                        className={`hover:bg-muted/20 grid min-w-140 grid-cols-[1fr_112px_120px_108px_88px] items-center gap-3 px-6 py-3 text-xs transition-colors ${
                      ...
                      >
                        <div className="flex items-center gap-1.5">
                          {isJackpot && (
                            <Badge
                              variant="secondary"
                              className="bg-red-100 font-bold text-red-700 dark:bg-red-900/50 dark:text-red-300"
                            >
                              JP
                            </Badge>
                          )}
                  ...
                  {/* Total row */}
                  <div className="bg-muted/30 grid min-w-140 grid-cols-[1fr_112px_120px_108px_88px] items-center gap-3 rounded-b-md border-t-2 px-6 py-2.5 text-xs font-semibold tracking-wider uppercase">
                    <span>Tổng cộng</span>
                    <span />
                    <span />
