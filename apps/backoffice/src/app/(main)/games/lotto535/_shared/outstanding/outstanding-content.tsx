...
/**
 * Orchestrator cho Lotto 5/35 Outstanding drill-down.
 *
 * Render đúng level component dựa trên URL state từ useLotto535OutstandingFilters.
 * KpiStrip chỉ hiển thị ở Level 1.
 * Breadcrumb hiển thị từ Level 2 trở lên.
 */
export function OutstandingContent() {
  const { drawId, tenantId, playerId, playerName, level } = useLotto535OutstandingFilters();

  const { data, isLoading, error, isFetching, refetch } = useLotto535Outstanding();
