...
import { Lotto535EntryDetailDialog } from "../../financial-reports/_lib/sections/entry-list";
import { useLotto535OutstandingPlayerEntries } from "../../financial-reports/_lib/use-report-queries";
...
/**
 * Level 4 — danh sách entries outstanding của 1 player Lotto 5/35.
 *
 * Click row → mở Lotto535EntryDetailDialog ở outstanding mode
...
export function OutstandingEntryList({
  ...
  const { data, isLoading, error, refetch } = useLotto535OutstandingPlayerEntries(
    drawId,
    tenantId,
    accountId,
  );
