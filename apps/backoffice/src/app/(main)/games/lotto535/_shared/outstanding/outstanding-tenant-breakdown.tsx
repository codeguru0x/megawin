...
import type { ListOutstandingDrawTenantsOutput } from "@megawin/game-lotto535-application/use-cases/reports";
...
import { useLotto535OutstandingDrawTenants } from "../../financial-reports/_lib/use-report-queries";
...
/**
 * Level 2 — tenant breakdown cho 1 draw outstanding Lotto 5/35.
 *
 * Tự gọi useLotto535OutstandingFilters() để lấy navigateToTenant.
...
export function OutstandingTenantBreakdown({ drawId }: OutstandingTenantBreakdownProps) {
  const { navigateToTenant } = useLotto535OutstandingFilters();
  const { data, isLoading, error, refetch } = useLotto535OutstandingDrawTenants(drawId);
