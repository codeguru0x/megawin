...
interface OutstandingDrawListProps {
  /** Danh sách draws outstanding (từ useLotto535Outstanding). */
  data: OutstandingDrawReport[];
}

/**
 * Level 1 — bảng danh sách kỳ quay outstanding Lotto 5/35.
 *
 * Tự gọi useLotto535OutstandingFilters() để lấy navigateToDraw.
...
export function OutstandingDrawList({ data }: OutstandingDrawListProps) {
  const { navigateToDraw } = useLotto535OutstandingFilters();
