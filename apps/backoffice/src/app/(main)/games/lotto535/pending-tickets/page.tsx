...
const MOCK_TENANT_SUMMARY = [
  {
    ...
    entryCount: 3420,
    totalLines: 8540,
    totalAmount: 85_400_000,
    playerCount: 245,
    avgAmountPerPlayer: 348_571,
  },
  {
    tenantId: "T002",
...
export default function PendingTicketsPage() {
  ...
  return (
    <div className="@container/main flex flex-col gap-4 md:gap-6">
      ...
      <Card className="bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Select defaultValue="all">
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="mainCover">Bao chính</SelectItem>
                    <SelectItem value="mainCover4">Bao 4</SelectItem>
                    <SelectItem value="specialCover">Bao ĐB</SelectItem>
                  </SelectContent>
                </Select>
