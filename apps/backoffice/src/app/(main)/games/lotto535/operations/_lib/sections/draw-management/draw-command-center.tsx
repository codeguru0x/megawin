...
export function DrawCommandCenter({
  ...
  const cardBg =
    {
      ...
      [DrawStatus.Settled]: "bg-linear-to-br from-muted/60 via-card to-muted/30 dark:via-card",
      [DrawStatus.Scheduled]: "bg-linear-to-br from-muted/60 via-card to-muted/30 dark:via-card",
  ...
  // Chỉ các trạng thái "sống" mới có animation ping
  const showPing = [
  ...
  return (
    <div className={cn("overflow-hidden rounded-xl border", cardBorder, cardBg)}>
      {/* Top accent bar — gradient theo status */}
