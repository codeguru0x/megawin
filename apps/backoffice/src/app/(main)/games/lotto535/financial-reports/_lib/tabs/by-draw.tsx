...
import { Building2, CalendarRange, ChevronRight, Users, Ticket } from "lucide-react";
import {
  Table,
  TableBody,
  TableCell,
...
function DrawList() {
  ...
  const { data, isLoading, error } = useLotto535DrawList(from, to, 1);
...
/** Tab "Theo kỳ quay" — 4 cấp drill-down, Lotto 5/35. */
