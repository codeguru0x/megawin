...
import { useLotto535Outstanding } from "../financial-reports/_lib/use-report-queries";
...
function OutstandingTable() {
  const { data, isLoading, error, dataUpdatedAt, isFetching, refetch } = useLotto535Outstanding();
      ...
      <Card className="gap-0 py-0">
        <CardHeader className="px-5 pb-2 pt-4">
          ...
          <CardDescription className="text-xs">
            Tự động refresh mỗi 60 giây · Lotto 5/35 có tối đa ~4 kỳ outstanding
          </CardDescription>
        </CardHeader>
          ...
          {filteredRows.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  {filteredRows.map((row) => (
                    <TableRow key={row.drawId}>
                      ...
                      <TableCell>
                        <Link
                          href={`/games/lotto535/operations?draw=${row.drawId}`}
                ...
                {/* Summary Footer Row — bỏ tổng player/tenant vì không có nghĩa cross-draw */}
