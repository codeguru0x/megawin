  ...
  return (
    <div
      className={cn(
        ...
        // Gradient mono-tone (1 hue, fade qua opacity) — token --game-lotto535-muted tự đổi
    ...
    >
      {/* Decorative orbs */}
      <div className="pointer-events-none absolute -top-10 -right-10 size-48 rounded-full bg-linear-to-br from-yellow-300/25 to-orange-300/15 blur-3xl dark:from-yellow-500/10 dark:to-orange-500/5" />
      <div className="pointer-events-none absolute bottom-0 -left-8 size-32 rounded-full bg-linear-to-tr from-amber-200/20 to-yellow-200/10 blur-2xl dark:from-amber-600/10 dark:to-yellow-600/5" />
      ...
      <div className="relative space-y-5">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <p className="text-xs font-medium tracking-wider text-amber-700/70 uppercase dark:text-amber-400/60">
                Jackpot hiện tại — Vòng #{cycle.cycleNo}
              </p>
              <p className="mt-0.5 text-3xl font-extrabold tracking-tight text-amber-900 tabular-nums dark:text-amber-100">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-xs">
            ...
            <span className="font-bold text-amber-900 tabular-nums dark:text-amber-200">{pct.toFixed(1)}%</span>
          </div>
