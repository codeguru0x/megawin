...
/**
 * Dialog sửa lịch kỳ quay Power 6/55.
 *
 * Validate: giờ mở bán < giờ đóng bán < giờ quay số.
 * Khoảng cách tối thiểu giữa đóng bán và quay số: 5 phút.
 */
export function EditScheduleAction({
  ...
  function handleSubmit() {
    ...
    // Tối thiểu 5 phút buffer giữa đóng bán và quay số
    if (new Date(drawISO).getTime() - new Date(closeISO).getTime() < 5 * 60_000) {
      setError("Cần ít nhất 5 phút giữa đóng bán và giờ quay số.");
      return;
    }
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Giờ đóng bán phải lớn hơn giờ mở bán và nhỏ hơn giờ quay số ít nhất 5 phút.
          </DialogDescription>
        </DialogHeader>
