...
import { usePower655OutstandingDrawTenants } from "../../financial-reports/_lib/use-report-queries";
 ...
 *
 * Tự gọi usePower655OutstandingFilters() để lấy navigateToTenant — cùng pattern với financial reports.
...
export function OutstandingTenantBreakdown({ drawId }: OutstandingTenantBreakdownProps) {
  const { navigateToTenant } = usePower655OutstandingFilters();
  const { data, isLoading, error, refetch } = usePower655OutstandingDrawTenants(drawId);
