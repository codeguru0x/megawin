...
import { usePower655OutstandingTenantPlayers } from "../../financial-reports/_lib/use-report-queries";
 ...
 *
 * Tự gọi usePower655OutstandingFilters() để lấy navigateToPlayer — cùng pattern với financial reports.
...
export function OutstandingPlayerBreakdown({ drawId, tenantId }: OutstandingPlayerBreakdownProps) {
  const { navigateToPlayer } = usePower655OutstandingFilters();
  const { data, isLoading, error, refetch } = usePower655OutstandingTenantPlayers(drawId, tenantId);
