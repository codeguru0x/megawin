...
import { Power655EntryDetailDialog } from "../../financial-reports/_lib/sections/entry-list";
import { usePower655OutstandingPlayerEntries } from "../../financial-reports/_lib/use-report-queries";
 ...
 *
 * Click row → mở Power655EntryDetailDialog ở outstanding mode
...
export function OutstandingEntryList({
  ...
  const { data, isLoading, error, refetch } = usePower655OutstandingPlayerEntries(
    drawId,
    tenantId,
    accountId,
  );
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="pr-5 w-[180px]">Thời gian đặt</TableHead>
