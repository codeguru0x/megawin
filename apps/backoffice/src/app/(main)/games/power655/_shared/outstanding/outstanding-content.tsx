...
/**
 * Orchestrator cho Power 6/55 Outstanding drill-down.
 *
 * Render đúng level component dựa trên URL state từ usePower655OutstandingFilters.
 * KpiStrip chỉ hiển thị ở Level 1.
 * Breadcrumb hiển thị từ Level 2 trở lên.
 */
export function OutstandingContent() {
  const { drawId, tenantId, playerId, playerName, level } = usePower655OutstandingFilters();

  const { data, isLoading, error, isFetching, refetch } = usePower655Outstanding();
