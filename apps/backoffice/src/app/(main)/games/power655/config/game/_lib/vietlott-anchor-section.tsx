 ...
 *
 * Power 6/55 quay theo THỨ trong tuần (`drawDaysOfWeek`) VÀ có NHIỀU giờ quay/tuần
 * (`drawTimes[]`) — neo phải rơi vào đúng 1 ngày quay VÀ đúng 1 trong các giờ quay hiện tại,
 * KHÔNG phải ngày/giờ bất kỳ. Chọn kỳ nào đang thấy trên trang Vietlott, càng gần hiện tại
 * càng tốt.
 */
