    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Nhập {POWER655_MAIN_COUNT} số chính ({pad2(POWER655_MAIN_MIN)}–
            {pad2(POWER655_MAIN_MAX)}) và 1 số bonus ({pad2(POWER655_MAIN_MIN)}–
            {pad2(POWER655_MAIN_MAX)}, khác các số chính).
            {isRepublish &&
        ...
        <div className="space-y-6 py-2">
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <div className="flex size-6 items-center justify-center rounded-md bg-red-100 dark:bg-red-900/50">
                <Dice5 className="size-3.5 text-red-600 dark:text-red-400" />
              </div>
            ...
            <div className="rounded-lg border bg-muted/30 p-4 space-y-4">
              <div className="space-y-2">
                <p className="text-xs text-muted-foreground">
                  {POWER655_MAIN_COUNT} số chính (không trùng)
                </p>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-1.5">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Số bonus ({pad2(POWER655_MAIN_MIN)}–{pad2(POWER655_MAIN_MAX)}, khác số chính)
                  </p>
                </div>
                <Input
                  type="text"
                  ...
                  className="w-20 text-center font-mono text-sm font-semibold tabular-nums border-blue-200 dark:border-blue-800"
