...
export default function Power655TicketsPage() {
    ...
    <div className="@container/main flex flex-col gap-4 md:gap-6">
      ...
      <Card>
        <CardContent className="flex flex-wrap items-center gap-2 py-3">
          ...
          <Input type="date" className="w-40" defaultValue="2026-02-24" />
              ...
              <TableBody>
                {filteredTickets.map((t) => (
                  <TableRow key={t.ticketNo}>
                    ...
                    <TableCell>
                      <Power655TicketStatusBadge status={t.status} />
                    </TableCell>
                    <TableCell>
                      <Button
                        variant="ghost"
