    ...
    <div className="@container/main flex flex-col gap-2">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="flex size-8 items-center justify-center rounded-lg bg-linear-to-br from-red-500 to-orange-600 shadow-sm">
          ...
          {config && (
            <Badge
              variant="secondary"
              className="border-red-200 bg-red-100 font-mono text-[11px] text-red-700 tabular-nums dark:border-red-800 dark:bg-red-950/50 dark:text-red-400"
            >
              v{config.version}
            </Badge>
          )}
