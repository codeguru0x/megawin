 ...
 *
 * Max 3D Pro quay theo THỨ trong tuần (`drawDaysOfWeek`, mặc định T3-T5-T7) VÀ có THỂ có
 * nhiều giờ quay/ngày (`drawTimes[]`) — neo phải rơi vào đúng 1 ngày quay VÀ đúng 1 trong
 * các giờ quay hiện tại, KHÔNG phải ngày/giờ bất kỳ. Chọn kỳ nào đang thấy trên trang
 * Vietlott, càng gần hiện tại càng tốt.
 */
        ...
        <form onSubmit={form.handleSubmit(handleSubmit)}>
          <CardContent className="p-6 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Nhập thông tin của MỘT kỳ bất kỳ đang hiển thị trên trang Vietlott (càng gần hiện tại càng tốt), ngày
                  và giờ neo phải LÀ một ngày/giờ quay theo lịch hiện tại. Hệ thống dùng neo này để tự gợi ý mã kỳ cho
                  các kỳ khác khi công bố kết quả.
                </p>
              </div>
            </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="text" placeholder="VD: 0293483" className="font-mono text-sm" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <p className="text-xs text-muted-foreground">
              ⚠️ Ngày bạn nhập ở trên phải là một ngày có quay số theo lịch hiện tại, và giờ quay phải đúng với 1 trong
              các giờ đang cấu hình ở mục "Lịch quay số" bên trên. Nếu sau này lịch quay số thay đổi (thứ trong tuần
              hoặc các giờ quay), phải cập nhật lại thông tin ở đây — nếu không, hệ thống sẽ gợi ý sai mã kỳ cho các kỳ
              sau.
            </p>
          </CardContent>
