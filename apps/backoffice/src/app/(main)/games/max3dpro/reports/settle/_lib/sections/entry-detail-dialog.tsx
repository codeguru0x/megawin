              ...
              <div className="space-y-2">
                {boards.map((board, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="grid [grid-template-columns:2rem_5rem_1fr] items-start gap-x-3 rounded-md border-l-[3px] border-l-[var(--board-color)] py-2 pr-2 pl-3"
                        ...
                        {board.playMode === "multiDigit" && board.frontDigits && board.backDigits ? (
                          <>
                            {board.frontDigits.map((d, j) => (
                              <span
                                key={`f-${j}`}
                                className="bg-muted text-muted-foreground inline-flex size-6 items-center justify-center rounded font-mono text-[11px] font-bold tabular-nums"
                              >
                                {d}
                              </span>
                            ))}
                            <span className="text-muted-foreground/40 px-0.5 text-[10px] select-none">×</span>
