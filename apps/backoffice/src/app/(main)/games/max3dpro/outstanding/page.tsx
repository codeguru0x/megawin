  ...
  const cards = [
    {
      ...
      sub: "kỳ quay chưa settle · Max 3D Pro ~2 kỳ/ngày",
    },
    {
      label: "Pending Entries",
      value: formatNumber(totalEntries),
      sub: `${formatNumber(totalLines)} cặp`,
...
function OutstandingTable() {
  const { data, isLoading, error, dataUpdatedAt } = useMax3DProOutstanding();
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="text-xs">
                Tự động refresh mỗi 60 giây · Max 3D Pro có tối đa ~4 kỳ outstanding (T2, T4, T6)
...
function Max3DProOutstandingContent() {
  return (
