...
const TIER_BADGE_COLORS: Partial<Record<PrizeTier, string>> = {
  [PrizeTier.Special]: "border-warning bg-warning text-warning",
  [PrizeTier.SpecialSub]: "border-warning bg-warning text-warning",
  [PrizeTier.First]: "border-warning bg-warning text-warning",
  [PrizeTier.Second]: "border-info bg-info text-info",
  [PrizeTier.Third]: "border-profit bg-profit text-profit",
};
