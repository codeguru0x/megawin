 ...
 * - Preview từ API gợi ý drawDate + drawTime theo lịch T3/T5/T7
        ...
        <div className="space-y-4 py-1">
          ...
          <div className="rounded-xl border overflow-hidden">
            ...
            <div
              ...
              style={{ gridTemplateColumns: "3rem 1fr 6.5rem 9rem" }}
            >
            ...
            {/* Rows */}
            <div className="divide-y divide-border/50 overflow-auto max-h-[40vh]">
              {rows.map((row, i) => {
