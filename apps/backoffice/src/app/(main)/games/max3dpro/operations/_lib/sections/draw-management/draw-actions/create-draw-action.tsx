 ...
 *
 * Tạo nhiều kỳ quay Max 3D Pro liên tiếp (1 kỳ/ngày, lịch T3/T5/T7 lúc 18:00).
...
/** Số kỳ mặc định mỗi lần mở dialog — Max 3D Pro quay 3 kỳ/tuần (T3/T5/T7), mặc định 1 tuần. */
      ...
      <DialogContent className="sm:max-w-2xl">
          ...
          <div className="flex items-end gap-4 flex-wrap">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  if (!isNaN(v) && v >= 1 && v <= MAX3D_PRO_CREATE_DRAW_BATCH_MAX) {
                    setCount(v);
                  }
                }}
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex h-9 flex-wrap items-center gap-1.5">
                ...
                {openCount > 0 && (
                  <Badge className="bg-pink-600 hover:bg-pink-600 text-white text-xs">{openCount} mở bán</Badge>
                )}
                {scheduledCount > 0 && (
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={!canSubmit}
            className={cn(openCount > 0 && "bg-pink-600 hover:bg-pink-700 text-white")}
          >
