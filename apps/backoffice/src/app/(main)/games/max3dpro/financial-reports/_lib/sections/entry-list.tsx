        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              { label: "Cặp (bộ ba đôi)", value: formatNumber(entry.lineCount) },
...
/** Cấp 4 drill-down: entries của 1 player × 1 draw × 1 tenant — Max 3D Pro. */
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-center">Cặp</TableHead>
