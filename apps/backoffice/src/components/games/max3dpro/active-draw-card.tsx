...
import type { CurrentDrawInfo } from "@/app/(main)/games/max3dpro/draws/_lib/use-draws";
import { DrawStatusBadge } from "@/components/games/max3dpro/draw-status-badge";
import { Tooltip, TooltipContent, TooltipTrigger } from "@/components/ui/tooltip";
import { cn } from "@/lib/utils";

// ─── Status → visual mapping ─────────────────────────────────────────────────
// Max 3D Pro dùng tông màu pink/rose — T3/T5/T7, game triplet cặp
...
> = {
  ...
  [DrawStatus.SalesOpen]: {
    border: "border-game-max3dpro border-game-max3dpro",
    accent: "from-game-max3dpro via-loss to-game-max3dpro",
    cardBg: "bg-linear-to-br from-game-max3dpro/60 via-card to-loss/30 from-game-max3dpro/20 dark:via-card",
    iconBg: "bg-game-max3dpro bg-game-max3dpro/60",
    iconColor: "text-game-max3dpro text-game-max3dpro",
    pingColor: "bg-game-max3dpro",
    dotColor: "bg-game-max3dpro",
  },
      ...
      <div className="space-y-4 px-5 py-4">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <div title={undefined} className="flex cursor-default items-center gap-1.5 select-none">
                <Clock className="text-game-max3dpro size-3.5" />
                <span className="text-muted-foreground text-xs">Quay số</span>
                <span className="text-game-max3dpro text-game-max3dpro font-mono text-xs font-bold tabular-nums">
                  {drawTime}
                </span>
              </div>
            </TooltipTrigger>
      ...
      <div className="space-y-3 p-4">
        ...
        <div className="text-muted-foreground flex items-center gap-3 text-xs">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <span className="flex cursor-default items-center gap-1 select-none">
                <Clock className="text-game-max3dpro size-3" />
