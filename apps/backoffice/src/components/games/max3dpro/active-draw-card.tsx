...
> = {
  ...
  [DrawStatus.SalesOpen]: {
    ...
    accent: "from-pink-400 via-rose-500 to-pink-500",
    cardBg:
      "bg-linear-to-br from-pink-50/60 via-card to-rose-50/30 dark:from-pink-950/20 dark:via-card dark:to-rose-950/10",
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <div title={undefined} className="flex items-center gap-1.5 cursor-default select-none">
                ...
                <span className="text-xs font-mono font-bold tabular-nums text-pink-600 dark:text-pink-400">
                  {drawTime}
                </span>
              </div>
            </TooltipTrigger>
