...
> = {
  ...
  [DrawStatus.SalesOpen]: {
    ...
    cardBg:
      "bg-linear-to-br from-teal-50/60 via-card to-emerald-50/30 dark:from-teal-950/20 dark:via-card dark:to-emerald-950/10",
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center gap-1.5 cursor-default select-none">
                  <Unlock className="size-3.5 text-teal-500" />
                  <span className="text-xs text-muted-foreground">Mở bán</span>
                  <span className="text-xs font-mono font-bold tabular-nums text-teal-600 dark:text-teal-400">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="flex items-center gap-3 rounded-xl border bg-white/80 dark:bg-card p-3">
              <div className="flex size-8 items-center justify-center rounded-lg bg-teal-100 dark:bg-teal-900/50">
                <CircleDollarSign className="size-3.5 text-teal-600 dark:text-teal-400" />
              </div>
              <div>
