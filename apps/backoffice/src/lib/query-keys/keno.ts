...
export const kenoKeys = {
  ...
  /**
   * Operations dashboard – snapshot gộp (stats + alertCounts + drawStatus).
   * Timer 1 duy nhất; thay opsSummary/tenant/numberFreq/playtype/topCombos.
   */
  ...
  /** Operations dashboard – tra cứu combo cappable (on-demand khi bấm Check). */
