/**
 * Lambda: feed-scheduler (Bingo 18)
 *
...
import { AcquireFeedLockUseCase } from "@megawin/game-bingo18-application/use-cases/feed";
...
export async function handler() {
  const executionName = `bingo18-feed-sync-${Date.now()}`;
