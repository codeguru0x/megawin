/**
 * Glue wiring test — worker-bingo18 (mock use-case, KHÔNG chạm DB).
 *
 ...
 * không kết nối DB thật. Logic nghiệp vụ đã test ở game-bingo18-application.
 */
...
vi.mock("@megawin/game-bingo18-application/use-cases/settle", () => ({
...
describe("worker-bingo18 settle-entries handler", () => {
