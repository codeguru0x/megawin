...
const BIG_SMALL_LABELS: Record<string, { label: string; color: string }> = {
  big: { label: "Lớn", color: "bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-300" },
  bigSmallDraw: { label: "Hoà L/N", color: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300" },
...
const EVEN_ODD_LABELS: Record<string, { label: string; color: string }> = {
  ...
  even1112: { label: "Chẵn 11-12", color: "bg-sky-100 text-sky-700 dark:bg-sky-900 dark:text-sky-300" },
  evenOddDraw: { label: "Hoà C/L", color: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300" },
  odd1112: { label: "Lẻ 11-12", color: "bg-pink-100 text-pink-700 dark:bg-pink-900 dark:text-pink-300" },
