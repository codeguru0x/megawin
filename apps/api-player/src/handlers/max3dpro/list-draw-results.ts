/**
 * Lambda handler: GET /games/max3dpro/draw-results
 * Danh sách kết quả kỳ quay Max 3D Pro đã settle.
 *
...
import { ListDrawResultsPlayerUseCase } from "@megawin/game-max3dpro-application/use-cases/player";
...
export const handler = withPlayerAuth(
  ...
  },
  {
    ...
    rateLimit: { route: "max3dpro.draw-results", ...READ_RATE_LIMIT },
  },
);
