/**
 * Lambda handler: GET /games/max3d/tickets/completed
 * Danh sách vé Max 3D đã hoàn thành (settled, refunded, void).
 */
...
} from "@megawin/game-max3d-application/use-cases/player";
