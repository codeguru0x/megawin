/**
 * Lambda handler: GET /games/max3d/entries/{entryId}/lines
 * Lấy danh sách lines (bộ ba số) + kết quả match của 1 entry.
 * Chỉ trả khi entry đã settled.
 */

import { withPlayerAuth } from "@megawin/auth";
import { GetEntryLinesPlayerUseCase } from "@megawin/game-max3d-application/use-cases/player";
import { z } from "zod";
...
export const handler = withPlayerAuth(
  ...
  },
  {
    ...
    rateLimit: { route: "max3d.entry-lines", ...READ_RATE_LIMIT },
  },
);
