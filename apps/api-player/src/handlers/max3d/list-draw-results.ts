/**
 * Lambda handler: GET /games/max3d/draw-results
 * Danh sách kết quả kỳ quay Max 3D đã settle.
 *
...
import { ListDrawResultsPlayerUseCase } from "@megawin/game-max3d-application/use-cases/player";
