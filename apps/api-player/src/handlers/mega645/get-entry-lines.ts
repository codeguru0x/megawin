/**
 * Lambda handler: GET /player/mega645/entries/{entryId}/lines
 * Lấy danh sách lines (bộ số con) + kết quả match của 1 entry.
 * Chỉ trả khi entry đã settled.
 */

import { withPlayerAuth } from "@megawin/auth";
import { GetEntryLinesPlayerUseCase } from "@megawin/game-mega645-application/use-cases/player";
import { z } from "zod";
...
export const handler = withPlayerAuth(
  ...
  },
  {
    ...
    rateLimit: { route: "mega645.entry-lines", ...READ_RATE_LIMIT },
  },
);
