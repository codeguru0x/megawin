/**
 * Lambda handler: GET /player/keno/tickets/completed
 * Danh sách vé Keno đã hoàn thành (settled, refunded, void).
 */
...
} from "@megawin/game-keno-application/use-cases/player";
