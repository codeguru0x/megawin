/**
 * Lambda: fetch-vietlott-mega645 (ResultFeed)
 *
 * Cùng cơ chế `fetch-vietlott-keno`, khác `gameKey` + `schedule`. Mega 6/45 quay 3
 * kỳ/tuần cố định (18:00 giờ VN — Thứ 4, Thứ 6, Chủ Nhật) — dùng `schedule: { type: "fixed" }`
...
const useCase = new FetchAndParseUseCase({
  ...
  // Thứ 4=3, Thứ 6=5, Chủ Nhật=0 (dayOfWeek(): 0=CN...6=T7) — xác nhận từ footer fixture.
  schedule: { type: "fixed", drawTimesVn: ["18:00"], drawDaysOfWeek: [3, 5, 0] },
