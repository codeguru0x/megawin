 ...
 * takeover. Distributed lock `mega645:ops-alerts` (TTL 120s) đảm bảo 1 invocation chạy tại
 * 1 thời điểm — độc lập lock với `mega645:stats-sync`.
 */

import { EvaluateOpsAlertsUseCase } from "@megawin/game-mega645-application/use-cases/operations";
