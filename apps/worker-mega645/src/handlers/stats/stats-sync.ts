/**
 * Lambda: stats-sync (Mega 6/45)
 *
 * Cập nhật collection pre-aggregated `mega645_draw_betting_stats` (+ number/account/combo
 ...
 * Distributed lock `mega645:stats-sync` (TTL 120s) đảm bảo 1 invocation chạy tại 1 thời điểm.
 *
...
import { SyncBettingStatsUseCase } from "@megawin/game-mega645-application/use-cases/operations";
