...
import type { OutstandingDrawReportEntity } from "@megawin/game-max3dpro/entities";
import type { Document } from "mongodb";

/**
 * Map MongoDB document (max3dpro_outstanding_draw_reports) → OutstandingDrawReportEntity.
 *
