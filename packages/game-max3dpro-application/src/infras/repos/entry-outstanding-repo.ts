/**
 * Max 3D Pro – Entry Outstanding Repository
 *
 * Collection: max3d_pro_ticket_entries (status = "scheduled" only)
 *
...
export class EntryOutstandingRepository extends BaseRepo<TicketEntryEntity, EntryMapper> {
   ...
   *
   * Max 3D Pro có lineCount (multiNumber: P(n,2), multiDigit: perms×perms).
   ...
   * (triplets, playMode multiNumber/multiDigit, betCount).
   * Index: { drawId: 1, tenantId: 1, accountId: 1 }
