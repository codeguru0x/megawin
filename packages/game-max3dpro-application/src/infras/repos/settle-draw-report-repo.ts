/**
 * Max 3D Pro – Settle Draw Report Repository
 *
 * Ghi/đọc per-game settle draw reports cho Max 3D Pro.
 * Collection: max3dpro_settle_draw_reports — 1 doc/draw.
 *
 * Methods:
...
import type { SettleDrawReport, SettleDrawReportEntity } from "@megawin/game-max3dpro/entities";
...
export class SettleDrawReportRepository extends BaseRepo<SettleDrawReportEntity, SettleDrawReportMapper> {
  constructor() {
    super({ collName: MAX3DPRO_SETTLE_DRAW_REPORTS, dataMapper: new SettleDrawReportMapper() });
  }
