/**
 * Use Case: Build Void Report (Max 3D Pro)
 *
 * ═══════════════════════════════════════════════════════════════════════
 ...
 *   0a. Đọc max3dpro_settle_draw_reports WHERE drawId → snapshot vào VoidPreviousSettleSnapshot
 *   0b. DELETE max3dpro_settle_tenant_reports WHERE drawId
 *   0c. DELETE max3dpro_settle_draw_reports WHERE drawId
 *
 ...
 *   2. Upsert max3dpro_void_draw_reports
 *
 * CRASH-SAFE:
...
import type { VoidPreviousSettleSnapshot } from "@megawin/game-max3dpro/entities";
