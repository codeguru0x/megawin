/**
 * Use Case: Get Vietlott Result (Max 3D Pro)
 *
 ...
 *
 * Thiết kế đầy đủ: `.cursor/plans/resultfeed/08-vietlott-result-autofill.plan.md` §6, §10 —
 * Max3DPro hiện chỉ có dữ liệu lịch sử (chưa có adapter fetch sống), nên nút "Lấy kết quả" sẽ
 * thường trả `found: false` cho kỳ mới — đúng hành vi fallback warning, không phải bug.
 */
