...
export const COGNITO_WORKFORCE_CLIENT_ID = process.env.COGNITO_WORKFORCE_CLIENT_ID;

export const COGNITO_PLAYER_POOL_ID = process.env.COGNITO_PLAYER_POOL_ID;
export const COGNITO_PLAYER_POOL_CLIENT_ID = process.env.COGNITO_PLAYER_POOL_CLIENT_ID;
