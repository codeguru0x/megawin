...
import type { OutstandingDrawReportEntity } from "@megawin/game-lotto535/entities";
import type { Document } from "mongodb";

/**
 * Map MongoDB document (lotto535_outstanding_draw_reports) → OutstandingDrawReportEntity.
 *
