/**
 * Lotto 5/35 – Settle Draw Report Repository
 *
 * Ghi/đọc per-game settle draw reports cho Lotto 5/35.
 * Collection: lotto535_settle_draw_reports — 1 doc/draw.
 *
 * Methods:
