 ...
 * Lotto 5/35 có lineCount (expanded lines từ bao).
 */
export interface OutstandingTenantBreakdownRow {
  ...
  playerCount: number;
  /** Tổng số lines pending. Lotto 5/35 luôn có. */
  lineCount: number;
 ...
 *
 * Filter: { drawId, "tenant.tenantId": tenantId, status: "scheduled" }, group by accountId.
 * Lotto 5/35 có lineCount.
 */
