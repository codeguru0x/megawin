/**
 * Use Case: Sync Outstanding (Lotto 5/35)
 *
 ...
 *   3. Merge kết quả → upsert lotto535_outstanding_draw_reports
...
export class SyncOutstandingUseCase extends InternalUseCase<void, SyncOutstandingResult> {
  ...
  protected async execute(_input: void): Promise<SyncOutstandingResult> {
    ...
    // Aggregate toàn bộ lotto535_outstanding_draw_reports → upsert system snapshot.
