...
/**
 * Lấy top N "bộ số phổ biến nhất" trong một kỳ quay.
 *
 * Nhóm boards theo combo key (playType + sorted mainNumbers + sorted specialNumbers),
 * rank theo entryCount (số entries chứa combo) giảm dần.
 *
 * Tối ưu hoá sau: có thể cache result hoặc materialise vào draw document.
 */
