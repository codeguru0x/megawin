/**
 * Use Case: Build Void Report (Lotto 5/35)
 *
 * ═══════════════════════════════════════════════════════════════════════
 ...
 *   0a. Đọc lotto535_settle_draw_reports WHERE drawId → snapshot vào VoidPreviousSettleSnapshot
 *   0b. DELETE lotto535_settle_tenant_reports WHERE drawId
 *   0c. DELETE lotto535_settle_draw_reports WHERE drawId
 *
 ...
 *   2. Upsert lotto535_void_draw_reports
 *
 * CRASH-SAFE:
...
import type { VoidPreviousSettleSnapshot } from "@megawin/game-lotto535/entities";
