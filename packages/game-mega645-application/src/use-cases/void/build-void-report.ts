/**
 * Use Case: Build Void Report (Mega 6/45)
 *
 * ═══════════════════════════════════════════════════════════════════════
 ...
 *   0a. Đọc mega645_settle_draw_reports WHERE drawId → snapshot vào VoidPreviousSettleSnapshot
 *   0b. DELETE mega645_settle_tenant_reports WHERE drawId
 *   0c. DELETE mega645_settle_draw_reports WHERE drawId
 *
 ...
 *   2. Upsert mega645_void_draw_reports
 *
 * CRASH-SAFE:
...
import type { VoidPreviousSettleSnapshot } from "@megawin/game-mega645/entities";
