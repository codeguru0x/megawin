/**
 * Use Case: Sync Outstanding (Mega 6/45)
 *
 ...
 *   3. Merge kết quả → bulk upsert mega645_outstanding_draw_reports (1 DB call)
...
export class SyncOutstandingUseCase extends InternalUseCase<void, SyncOutstandingResult> {
  ...
  protected async execute(_input: void): Promise<SyncOutstandingResult> {
    ...
    // Mega645 thường có 1-2 draws active (T4, T6, CN).
    ...
    // Aggregate toàn bộ mega645_outstanding_draw_reports → upsert system snapshot.
