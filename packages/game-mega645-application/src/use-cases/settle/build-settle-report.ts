/**
 * Use Case: Build Settle Report (Mega 6/45)
 *
 * ═══════════════════════════════════════════════════════════════════════
 ...
 *   2. Upsert SettleTenantReport[] vào mega645_settle_tenant_reports
...
/**
 * Xây dựng per-game settle reports cho Mega 6/45.
 *
...
> {
  ...
  protected async execute(input: SettleContext): Promise<BuildSettleReportResult> {
    ...
    // Mega 6/45: jackpotContribution = financials.jackpotContribution (single jackpot)
    // Nếu không có financials (edge case), dùng 0
