/**
 * Cache module: Tenant Config (Mega 6/45).
 *
...
import type { TenantConfigEntity } from "@megawin/game-mega645/entities";
...
const fetcher = createCachedFetcher<string, TenantConfigEntity | null>(
  (tenantId) => getRepo().getTenantConfig(tenantId),
  {
    ...
    keyPrefix: MEGA645_CACHE_KEYS.tenantConfig,
    ttlSec: 60 * 10, // 10 minutes
  },
);

/**
 * Cache read-through cho tenant config Mega 6/45 (per tenantId).
 *
