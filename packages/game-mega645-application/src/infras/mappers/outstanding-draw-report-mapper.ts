...
import type { OutstandingDrawReportEntity } from "@megawin/game-mega645/entities";
import type { Document } from "mongodb";

/**
 * Map MongoDB document (mega645_outstanding_draw_reports) → OutstandingDrawReportEntity.
 *
