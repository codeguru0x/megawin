/**
 * Mega 6/45 – Ops Alert Repository
 *
 * Collection: mega645_ops_alerts — 1 doc/(draw × dedupeKey). Alert-driven ops.
 *
 ...
 *
 * Port nguyên kiến trúc từ Power 6/55 (`ops-alert-repo.ts`) — `countByStatus` nhận
...
export class OpsAlertRepository extends BaseRepo<Mega645OpsAlertEntity, OpsAlertMapper> {
  constructor() {
    super({
      collName: Mega645Collections.OpsAlerts,
