 ...
 */
export interface KenoNumberSelection {
 ...
 */
export interface KenoBigSmallSelection {
  /**
   * Lựa chọn cược:
   ...
   */
  bet: import("./keno.enums").KenoBigSmallBet;
}

/**
 * Lựa chọn cách chơi bổ sung Chẵn/Lẻ (Panel C).
 */
export interface KenoEvenOddSelection {
  /**
   * Lựa chọn cược:
   ...
   * - "odd": Lẻ (≥15 số lẻ)
   */
  bet: import("./keno.enums").KenoEvenOddBet;
}
