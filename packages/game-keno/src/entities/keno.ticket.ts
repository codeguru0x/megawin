 ...
 */
export interface KenoBasicBoard {
  /**
   * Mã board: "A", "B".
   */
  boardNo: string;
...
export interface KenoSideBet {
   ...
   * - "evenOdd": Chẵn/Lẻ
   */
  playType: typeof import("./keno.enums").KenoPlayType.BigSmall | typeof import("./keno.enums").KenoPlayType.EvenOdd;
...
export interface KenoTicketDoc {
  _id: unknown;
  ...
  boards: KenoBasicBoard[];

  // ───── Side Bets (Panel C) ─────

  sideBets: KenoSideBet[];
