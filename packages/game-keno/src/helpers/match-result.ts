...
export function matchBigSmallBet(
  ...
  switch (bet) {
    case KenoBigSmallBet.Big: {
      if (bigCount >= 13) {
        return { outcome: "big13Plus", isWin: true, winAmount: prizes.big13Plus };
      }
...
export function matchEvenOddBet(
  ...
  switch (bet) {
    ...
    case KenoEvenOddBet.Odd: {
      if (oddCount >= 15) {
        return { outcome: "odd15Plus", isWin: true, winAmount: prizes.odd15Plus };
      }
