...
import type { OutstandingDrawReportEntity } from "@megawin/game-bingo18/entities";
import type { Document } from "mongodb";

/**
 * Map MongoDB document (bingo18_outstanding_draw_reports) → OutstandingDrawReportEntity.
 *
