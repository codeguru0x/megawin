...
import type { ListCompanyAccountsOutput, CompanyAccountItem } from "./dto/list-company-accounts.dto";

export class ListCompanyAccountsUseCase extends NextApiUseCase<void, ListCompanyAccountsOutput> {
