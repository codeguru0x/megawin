# Kết sổ lại — Type B1 (Đổi người trúng Jackpot hoặc chia giải)

## Khi nào áp dụng

Dùng khi sửa kết quả một kỳ làm **thay đổi người trúng Jackpot** hoặc **thay đổi việc chia giải (split)** của kỳ đó — ví dụ:

- Xuất hiện / gỡ bỏ người trúng Jackpot.
- Kỳ đó từ "có chia giải" thành "không chia giải" hoặc ngược lại.
...
2. Mở màn **Vận hành** của Lotto 5/35, chọn kỳ cần sửa (đang ở trạng thái **Đã kết sổ**), bấm **Sửa kết quả** và nhập kết quả mới, rồi công bố. Kỳ chuyển sang **Đã công bố**.
