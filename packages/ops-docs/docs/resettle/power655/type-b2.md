...
1. Kết sổ lại kỳ hiện tại trên màn hình **Vận hành**:
   ...
   - Các kỳ **sau**: số quay **không đổi** nên hệ thống không tự mở luồng kết sổ lại. Bấm nút **"Mở để kết sổ lại"** (màu cam) để đưa kỳ vào luồng, rồi bấm **"Kết sổ lại"** như bình thường (tiền Jackpot kép JP1 + JP2 có thể đổi dù số quay giữ nguyên).
