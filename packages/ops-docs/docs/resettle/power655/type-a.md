...
Dùng khi cần sửa kết quả một kỳ quay đã công bố mà **kết quả mới lẫn cũ đều KHÔNG có ai trúng Jackpot** (cả Jackpot 1 và Jackpot 2). Đây là trường hợp đơn giản nhất: việc sửa chỉ ảnh hưởng đúng kỳ đó, không kéo theo kỳ khác.
...
1. Mở màn **Vận hành (Operations)** của Power 6/55, tìm đúng kỳ cần sửa (đang ở trạng thái **Đã kết sổ**).
2. Bấm **Sửa kết quả** và nhập kết quả mới (dãy số trúng + số đặc biệt), rồi công bố. Kết quả cũ bị ghi đè; kỳ chuyển sang trạng thái **Đã công bố**.
