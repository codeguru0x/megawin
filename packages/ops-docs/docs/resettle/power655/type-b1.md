...
2. Mở màn **Vận hành** của Power 6/55, chọn kỳ cần sửa (đang ở trạng thái **Đã kết sổ**), bấm **Sửa kết quả** và nhập kết quả mới, rồi công bố. Kỳ chuyển sang **Đã công bố**.
...
- Quản trị viên xác nhận chu kỳ Jackpot (số tiền tích luỹ Jackpot 1 / Jackpot 2) đã đúng.
