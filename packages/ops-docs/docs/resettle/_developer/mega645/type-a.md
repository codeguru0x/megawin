...
- Winner JP tại kỳ T **KHÔNG thay đổi**: cả kết quả cũ lẫn kết quả mới đều **KHÔNG** có ai trúng Jackpot (6/6 số) (case 4 trong bảng 2 chiều).
...
sequenceDiagram
    ...
    Staff->>BO_API: POST /publish-result {winningNumbers}
    ...
    BO_API->>DB: Đọc ledger entry (openingJp, seq)
