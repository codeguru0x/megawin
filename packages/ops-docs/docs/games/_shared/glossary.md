...
| **Line** | 1 tổ hợp số cụ thể được so khớp với kết quả quay. Chơi cơ bản (standard) luôn có đúng 1 line; chơi bao/tổ hợp sinh ra nhiều line từ 1 board. Số line được **tính**, không phải staff nhập tay — công thức thuộc phần cách chơi của từng game. |
