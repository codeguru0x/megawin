...
import type { OutstandingDrawReportEntity } from "@megawin/game-power655/entities";
import type { Document } from "mongodb";

/**
 * Map MongoDB document (power655_outstanding_draw_reports) → OutstandingDrawReportEntity.
 *
