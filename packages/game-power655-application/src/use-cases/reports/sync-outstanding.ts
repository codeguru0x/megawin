/**
 * Use Case: Sync Outstanding (Power 6/55)
 *
 ...
 *   3. Merge kết quả → bulk upsert power655_outstanding_draw_reports (1 DB call)
 ...
 *
 * Power 6/55 có lineCount — Bao 5 (50 lines) hoặc Bao 7-18 expand thành nhiều lines.
 */
...
export class SyncOutstandingUseCase extends UseCase<void, SyncOutstandingResult> {
  ...
  protected async execute(_input: void): Promise<SyncOutstandingResult> {
    ...
    // Power 6/55 quay T3, T5, T7 — thường có 1-2 draws active.
    ...
    // Power 6/55 có lineCount (Bao 5: 50 lines, Bao 7-18: C(N,6) lines).
    ...
    // Aggregate toàn bộ power655_outstanding_draw_reports → upsert system snapshot.
