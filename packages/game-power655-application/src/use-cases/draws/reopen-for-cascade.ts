/**
 * Use Case: Reopen For Cascade (Power 6/55) — mở cổng resettle cho kỳ T+n trong
 ...
 * (T+1…T+n) phải re-settle vì pool dual jackpot (JP1 + JP2) tích luỹ + ranh giới
 * cycle đổi. NHƯNG số quay (winningMain + bonusNumber) của T+1…T+n KHÔNG đổi —
 * chỉ số tiền/cycle tính lại.
 *
 ...
 * now` (GIỮ NGUYÊN winningMain + bonusNumber), chuyển `Settled → Published`,
