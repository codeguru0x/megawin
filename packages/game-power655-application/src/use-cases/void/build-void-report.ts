/**
 * Use Case: Build Void Report (Power 6/55)
 *
 * ═══════════════════════════════════════════════════════════════════════
 ...
 *   0a. Đọc power655_settle_draw_reports WHERE drawId → snapshot vào VoidPreviousSettleSnapshot
 *   0b. DELETE power655_settle_tenant_reports WHERE drawId
 *   0c. DELETE power655_settle_draw_reports WHERE drawId
 *
 ...
 *   2. Upsert power655_void_draw_reports
 *
 * CRASH-SAFE:
