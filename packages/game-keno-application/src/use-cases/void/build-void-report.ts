 ...
 *   0a. Đọc keno_settle_draw_reports WHERE drawId → snapshot vào VoidPreviousSettleSnapshot
 *   0b. DELETE keno_settle_tenant_reports WHERE drawId
 *   0c. DELETE keno_settle_draw_reports WHERE drawId
 *
 ...
 *   2. Upsert keno_void_draw_reports
 *
 * CRASH-SAFE:
