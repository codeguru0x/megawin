/**
 * Registry cache key của game-keno-application — 1 nơi duy nhất khai key.
 *
...
const NS = CacheNamespace.Keno;

/** Cache key prefix của Keno. Value = kết quả `cacheKey(...)`. */
export const KENO_CACHE_KEYS = {
