/**
 * System Outstanding Report Repository — Keno
 *
 * Kế thừa base SystemOutstandingReportRepository từ game-core.
 * Thêm perGameColl trỏ vào keno_outstanding_draw_reports.
 *
 * aggregateFromPerGame():
 *   Query keno_outstanding_draw_reports → SUM tất cả active draws
