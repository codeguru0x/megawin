/**
 * Registry cache key của game-max3d-application — 1 nơi duy nhất khai key.
 *
...
const NS = CacheNamespace.Max3d;

/** Cache key prefix của Max 3D. Value = kết quả `cacheKey(...)`. */
export const MAX3D_CACHE_KEYS = {
