...
import type { OutstandingDrawReportEntity } from "@megawin/game-max3d/entities";
import type { Document } from "mongodb";

/**
 * Map MongoDB document (max3d_outstanding_draw_reports) → OutstandingDrawReportEntity.
 *
