...
import { Max3dCollections, type TicketEntity } from "@megawin/game-max3d/entities";
...
/**
 * Repository quản lý Ticket lifecycle — Max 3D.
 *
 * Chỉ chứa query/update logic cho collection `max3d_tickets`.
