/**
 * Max 3D – Ops Alert Repository
 *
 * Collection: max3d_ops_alerts — 1 doc/(draw × dedupeKey). Alert-driven ops.
 *
...
import type { Max3dOpsAlertDoc, Max3dOpsAlertEntity } from "@megawin/game-max3d/entities";
import type { OpsAlertStatus as OpsAlertStatusType } from "@megawin/game-max3d/entities";
...
const f = docPath<Max3dOpsAlertDoc>();

export class OpsAlertRepository extends BaseRepo<Max3dOpsAlertEntity, OpsAlertMapper> {
  constructor() {
    super({
      collName: Max3dCollections.OpsAlerts,
