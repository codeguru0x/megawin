/**
 * Max 3D – Entry Outstanding Repository
 *
 * Collection: max3d_ticket_entries (status = "scheduled" only)
 *
...
export class EntryOutstandingRepository extends BaseRepo<TicketEntryEntity, EntryMapper> {
   ...
   *
   * Max 3D có lineCount (1 straight, 3 combo3, 6 combo6).
   ...
   *
   * Trả về full entity để dialog có thể hiển thị chi tiết boards (triplets, playMode, playType).
   * Index: { drawId: 1, tenantId: 1, accountId: 1 }
