...
import { OpsAlertSeverity, type Max3dOpsAlertEntity, type Max3dOpsAlertType } from "@megawin/game-max3d/entities";
...
export class ListAlertsUseCase extends UseCase<ListAlertsInput, ListAlertsOutput> {
  ...
  private groupByType(items: Max3dOpsAlertEntity[]): AlertGroup[] {
    const byType = new Map<Max3dOpsAlertType, AlertGroup>();
