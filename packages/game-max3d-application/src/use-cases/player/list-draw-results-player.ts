/**
 * Use Case: List Draw Results for Player (Max 3D)
 *
 ...
 * Xem chi tiết tại GET /games/max3d/draw-results/:drawId.
 *
 * Endpoint: GET /games/max3d/draw-results?from=YYYY-MM-DD&size=N&cursor=drawId
 */
...
/**
 * Danh sách kết quả kỳ quay Max 3D cho player.
