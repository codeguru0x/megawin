 ...
 *   0a. Đọc max3d_settle_draw_reports WHERE drawId → snapshot vào VoidPreviousSettleSnapshot
 *   0b. DELETE max3d_settle_tenant_reports WHERE drawId
 *   0c. DELETE max3d_settle_draw_reports WHERE drawId
 *
 ...
 *   2. Upsert max3d_void_draw_reports
 *
 * CRASH-SAFE:
