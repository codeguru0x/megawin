/**
 * Tính danh sách draw slots cho Max 3D.
 *
 * Max 3D quay vào T2/T4/T6 (drawDaysOfWeek = [1,3,5]) lúc 18:00.
...
import type { PlayRules } from "@megawin/game-max3d/entities";

export interface Max3dDrawSlot {
 ...
 */
export function calcMax3dDrawSlots(
  now: Date,
  count: number,
  config: PlayRules,
